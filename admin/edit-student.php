...
// Load batches
$batches = [];
$resB = $conn->query("SELECT id, name FROM batches WHERE status='active' ORDER BY name ASC");
if ($resB) {
    ...
    <form method="POST">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="emergency_contact_relation" value="<?php echo htmlspecialchars($student['emergency_contact_relation'] ?? ''); ?>">
            </div>
            <div class="form-group">
                <label>Emergency Contact Phone</label>
                <input type="text" name="emergency_contact_phone" value="<?php echo htmlspecialchars($student['emergency_contact_phone'] ?? ''); ?>">
            </div>
            <div class="form-group">
                <label>Batch</label>
                <select name="batch_id">
                    ...
                    <?php foreach ($batches as $b): ?>
                        <option value="<?php echo (int)$b['id']; ?>" <?php echo ((int)($student['batch_id'] ?? 0) === (int)$b['id']) ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <input type="date" name="join_date" value="<?php echo htmlspecialchars($student['join_date'] ?? ''); ?>">
            </div>
            <div class="form-group">
                <label>Status</label>
